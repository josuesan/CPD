...
public class Administrador implements Usuario{
    private String name;
    private String tipo = "GerenteResponsable";
    private String observerState;
    private ConcreteSubject subject;
    public Principal interfaz;
    /**
     * Constructor del GerenteResponsable.
     */
    public Administrador(){
    
    }
    /**
     * Usa la interfaz actual para actualizar los elementos de la cartelera junto con sus filtros en el cliente.
     */
    @Override
    public void Update() {
